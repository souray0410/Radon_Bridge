...
class BridgeExchange(nn.Module):
    def __init__(self, specs, *, M, S, rho, mode='radon', compression='learned_projected', basis_files=None):
        super().__init__()
...
def attach_group(node, edge, specs, inputs, prefix, *, M, S, rho, mode='radon', compression='learned_projected', basis_files=None):
    ...
    exchange = BridgeExchange(specs, M=M, S=S, rho=rho, mode=mode, compression=compression, basis_files=basis_files)
...
def attach_to_nodes(builder, node_names, *, prefix, M, S, rho, samples=None, mode='radon', compression='learned_projected', basis_files=None):
    ...
    result,meta=attach_group(builder.node,builder.edge,specs,inputs,prefix,M=M,S=S,rho=rho,mode=mode,compression=compression,basis_files=basis_files)
