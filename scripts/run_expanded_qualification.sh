...
exec 9>/data/mengh/RadonBridge/.exp008_qualification_launch.lock
flock -n 9 || exit 92
run_root=/data/mengh/RadonBridge/runs/exp008_qualification
...
/home/mengh/LOOK/2026_08_30_11_20_47/tool/environment/.venv/bin/python -m radonbridge.sweep \
  ...
  --protocol experiments/008-expanded-validation/qualification_protocol.json \
