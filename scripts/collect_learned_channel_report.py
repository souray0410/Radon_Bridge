        ...
        while True:
            try:
                ...
                if queue['state']=='complete':
                    report=remote('report/report_status.json');assert report['complete_trials']==report['total_trials']==129 and report['seeds']==[3416,3417,3418]
                    ...
                    status('collected_pending_visual_review',complete_trials=129);return
