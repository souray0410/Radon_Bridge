"""A globally factorized, bias-free linear convolution in projected space.

Unlike the historical per-source codecs, A and B mix all source CM channels.
W[t] = B K[t] A. Exporting W is for bounded equivalence tests, not execution.
"""
import torch
