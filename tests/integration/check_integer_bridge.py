...
from radon_bridge.projector import Projector, eem_directions, geometry, householder
from radon_bridge.bridge import attach_to_nodes, LinearMixer
from radon_bridge.graph import MHDBuilder
...
def topology_check(dims, repeated=False, participant_sampling=False, compression="learned_projected", basis_files=None, mode="radon", s_axis_permutation=None):
    ...
    _, meta=attach_to_nodes(b,cuts,prefix='bridge_0_',M=directions,S=11,rho=ratios,samples=samples,compression=compression,basis_files=basis_files,mode=mode,s_axis_permutation=s_axis_permutation)
