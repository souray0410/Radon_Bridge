...
import tempfile
import torch
from radon_bridge.svd_basis import FixedChannelBasis,save_basis
from radon_bridge.bridge import BridgeExchange,FeatureSpec
from radon_bridge.projector import Projector
from radon_bridge.model import PilotGraph
from radon_bridge.optimization import configure_optimizer,clip_task_gradients
...
def checkpoint_optimizer_checks(tmp,compression='fixed_svd_channel',basis_factory=artifact,bridge_overrides=None):
    ...
    if bridge_overrides:cfg.update(bridge_overrides)
