...
|中心化SVD基方向|[已接受WS02单种子包](centered_basis/README.md)：旧未中心化Radon/普通严格复用，中心化Radon/普通两新臂完成；左侧独立复核91源码、3160资产/输入、basis数值关系、296人指标、停止历史与3项10k区间|两个直接中心化效应区间均跨0；F1与log-loss/AUROC方向冲突，不继续为centered堆r/种子/骨干|
